...
{
    internal class JMAssetBundleSettingView : EditorWindow, IEditorView
    {
        #region Variable
        ...
        public JMAssetBundleSettingView()
        {
        ...
        {
            JMAssetBundleSettingView settingWindow = GetWindow<JMAssetBundleSettingView>();

            settingWindow.titleContent = new GUIContent("JMABSetting");
